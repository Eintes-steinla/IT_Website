...
<body class="bg-main font-[exo2-regular]">
    <div class="relative sm:mx-auto py-4 sm:max-w-xl">
        <div
            ...
            <div class="mx-auto max-w-md text-normal">
                <div class="flex justify-center items-center">
                    ...
                    <!-- <h1 class="font-[exo2-extrabold] text-normal text-2xl">Sign up</h1> -->
                </div>
                ...
                <div class="gap-5 grid grid-cols-1 sm:grid-cols-2 mt-5">
                    ...
                    <div>
                        ...
                        <select
                            class="bg-input mt-1 mb-5 px-3 py-2 border border-input rounded-lg focus:ring-1 focus:ring-white w-full text-normal text-sm"
                            id="gender">
                            Male
    ...
    <script>
        ...
        // const ulGender = document.querySelector("ul");
        // gender.addEventListener("click", () => {
        //     if (ulGender.classList.contains("hidden")) {
        //         ulGender.classList.remove("hidden");
        //     } else {
        //         ulGender.classList.add("hidden");
        //     }
        // });
    </script>
</body>
