        ...
        <div
            ...
            <div class="mx-auto max-w-md text-normal">
                ...
                <div class="gap-5 grid grid-cols-1 sm:grid-cols-2 mt-5">
                    <div>
                        <label
                            class="block pb-1 font-[exo2-bold] text-normal text-sm"
                ...
                <div class="gap-5 grid grid-cols-1 sm:grid-cols-2 mt-5">
                    <div>
                        ...
                        <input
                            class="bg-input mt-1 mb-5 px-3 py-2 border border-input rounded-lg w-full text-normal text-sm select-none"
                            type="date"
                            id="dob" />
                    </div>
                    <div>
                        ...
                        <button
                            class="group relative bg-input mt-1 mb-5 px-3 py-2 border border-input rounded-lg focus:ring-1 focus:ring-white w-full text-normal text-sm"
                            id="gender">
                            Male
                            <ul class="group-hover:block hidden absolute bg-input">
                ...
                <div class="flex justify-center items-center">
                    <div>
                        <button
                            class="flex justify-center items-center bg-white hover:bg-gray-200 shadow-md px-20 py-2 rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 w-full font-[exo2-bold] text-gray-700 text-base text-center transition duration-200 ease-in cursor-pointer">
                            <svg
                                viewBox="0 0 24 24"
                                height="25"
                                width="25"
                            ...
                            <span class="hidden md:block ml-2">Sign up with Google</span>
                        </button>
                        <button
                            class="flex justify-center items-center bg-white hover:bg-gray-200 shadow-md mt-4 px-20 py-2 rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 w-full font-[exo2-bold] text-gray-700 text-base text-center transition duration-200 ease-in cursor-pointer">
                            <svg
                                viewBox="0 0 30 30"
                                height="30"
                                width="30"
                            ...
                            <span class="hidden md:block ml-2">Sign up with Apple</span>
                        </button>
                        <button
                            class="flex justify-center items-center bg-white hover:bg-gray-200 shadow-md mt-4 px-20 py-2 rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 w-full font-[exo2-bold] text-gray-700 text-base text-center transition duration-200 ease-in cursor-pointer">
                            ...
                            <span class="hidden md:block ml-2">Sign up with Github</span>
                        </button>
                    </div>
                </div>
                <div class="mt-5">
                    <button
                        class="shadow-md px-4 py-2 rounded-lg focus:outline-none focus:ring-blue-500 focus:ring-2 focus:ring-offset-2 w-full font-[exo2-bold] text-normal text-base text-center transition duration-200 ease-in cursor-pointer hover-button-bg button-bg"
                        type="submit">
                        Sign up
                    </button>
                </div>
                <div class="flex justify-between items-center mt-4">
                    <span class="border-b w-1/5 md:w-1/4 text-note"></span>
                    <a
                        class="text-note dark:text-normal text-xs hover:underline uppercase"
