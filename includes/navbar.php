<nav class="bg-gray-800 px-4 w-full h-16">
    <div class="flex justify-between items-center md:space-x-4 h-full">
        ...
        <div class="hidden sm:block relative md:w-1/4" id="input">
            <input
                value=""
                placeholder="Search..."
                class="peer block bg-white px-4 pr-[48px] border border-slate-200 invalid:focus:border-error-500 invalid:border-error-500 focus:border-transparent hover:border-brand-500-secondary- rounded-[8px] focus:outline-2 focus:outline-primary focus:ring-0 w-full h-[35px] overflow-ellipsis overflow-hidden text-slate-900 text-sm text-nowrap appearance-none"
                id="floating_outlined"
                type="text" />
            <label
                class="rtl:peer-focus:left-auto peer-focus:z-10 peer-focus:px-2 peer-focus:top-2 peer-placeholder-shown:-z-10 peer-placeholder-shown:top-1/2 top-2 z-10 absolute bg-white data-[disabled]:bg-gray-50-background- px-2 text-[14px] text-primary peer-focus:text-primary focus:invalid:text-error-500 peer-invalid:text-error-500 leading-[150%] scale-75 peer-focus:scale-75 peer-placeholder-shown:scale-100 origin-[0] -translate-y-[1.2rem] rtl:peer-focus:translate-x-1/4 peer-focus:-translate-y-[1.2rem] peer-placeholder-shown:-translate-y-1/2 duration-300 transform start-1"
        ...
        <div class="flex items-center gap-4">
            ...
            <button class="hidden md:block">
                <svg
                    ...
                    height="26"
                    fill="white"
                    class="hover:scale-105 active:scale-95 transition-all duration-200 ease-in-out cursor-pointer bi bi-bell-fill"
                    viewBox="0 0 16 16">
