<nav class="bg-main px-4 w-full h-16">
    <div class="flex justify-between items-center md:space-x-4 h-full">
        ...
        <div class="flex items-center gap-4">
            ...
            <!-- user -->
            <button id="user" class="hidden md:block z-50 relative active:scale-95 transition-all duration-200 ease-in-out">
                <a href="#">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="26"
                ...
                <ul class="hidden right-0 z-50 absolute space-y-2 bg-dropdown mt-3 px-2 py-2 rounded font-[exo2-bold] text-dropdown text-left normal-case text-nowrap">
